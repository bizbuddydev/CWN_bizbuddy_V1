...
st.markdown("<h2 style='text-align: center;'>Chelsea Whealdon Nutrition</h2>", unsafe_allow_html=True)
...
def main():
    ...
    with sq_col2:
        ...
        seo_url = f"https://cwn-bizbuddy-seo.streamlit.app?message={encoded_message}"
